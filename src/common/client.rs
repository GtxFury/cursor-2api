...
use crate::app::{
    constant::{
        ...
        header::{
            ...
            CURSOR_CHECKSUM, CURSOR_CLIENT_ARCH, CURSOR_CLIENT_DEVICE_TYPE, CURSOR_CLIENT_OS,
            CURSOR_CLIENT_TYPE, CURSOR_CLIENT_VERSION, CURSOR_CONFIG_VERSION, CURSOR_ORIGIN,
            CURSOR_REFERER_URL, CURSOR_STREAMING, CURSOR_TIMEZONE, DESKTOP, EMPTY, ENCODING,
            ENCODINGS, FALSE, FS_CLIENT_KEY, GHOST_MODE, HEADER_VALUE_ACCEPT, HOST, IDE, JSON,
            KEEP_ALIVE, LANGUAGE, MOBILE_NO, NEW_ONBOARDING_COMPLETED, NO_CACHE, NONE,
            NOT_A_BRAND, ONE, PRIORITY, PROTO, PROXY_HOST, REQUEST_ID, SAME_ORIGIN, SEC_CH_UA,
            SEC_CH_UA_MOBILE, SEC_CH_UA_PLATFORM, SEC_FETCH_DEST, SEC_FETCH_MODE, SEC_FETCH_SITE,
            SEC_GPC, SESSION_ID, TRAILERS, TRUE, U_EQ_0, U_EQ_1_I, VSCODE_ORIGIN, X64, ZERO,
        },
    },
    lazy::{
...
pub fn build_client_request(req: AiServiceRequest) -> RequestBuilder {
    ...
    builder
        ...
        .header(CURSOR_CLIENT_ARCH, X64)
        .header(CURSOR_CLIENT_DEVICE_TYPE, DESKTOP)
        .header(CURSOR_CLIENT_OS, platform::current().os_header_value())
